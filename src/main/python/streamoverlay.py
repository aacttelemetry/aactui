...
class Ui_OverlayWindow(object):
    def setupUi(self, OverlayWindow):
        ...
        self.athlete_checkbox = QtWidgets.QCheckBox(self.groupBox)
        self.athlete_checkbox.setObjectName("athlete_checkbox")
        self.verticalLayout_3.addWidget(self.athlete_checkbox)
        ...
        self.gridLayout_3.addWidget(self.obst_subtract_button, 7, 0, 1, 1)
        self.obst_add_button = QtWidgets.QPushButton(self.groupBox)
        self.obst_add_button.setObjectName("obst_add_button")
        self.gridLayout_3.addWidget(self.obst_add_button, 7, 1, 1, 2)
    ...
    def retranslateUi(self, OverlayWindow):
        ...
        self.athlete_checkbox.setText(_translate("OverlayWindow", "Athlete data"))
        ...
        self.score_set_button.setToolTip(_translate("OverlayWindow", "Set the current score to the value above."))
        self.score_set_button.setText(_translate("OverlayWindow", "Set"))
        self.label_6.setText(_translate("OverlayWindow", "Score control:"))
        self.score_add_button.setToolTip(_translate("OverlayWindow", "Add the value above to the current score."))
        ...
        self.score_subtract_button.setToolTip(_translate("OverlayWindow", "Subtract the value above from the current score."))
        ...
        self.obst_subtract_button.setToolTip(_translate("OverlayWindow", "Add the full value of the previous obstacle."))
        self.obst_subtract_button.setText(_translate("OverlayWindow", "Add last (7 pts)"))
        self.obst_add_button.setToolTip(_translate("OverlayWindow", "Subtract the full value of the previous obstacle."))
        self.obst_add_button.setText(_translate("OverlayWindow", "Subtract last (7 pts)"))
