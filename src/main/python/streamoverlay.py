...
class Ui_OverlayWindow(object):
    def setupUi(self, OverlayWindow):
        ...
        self.test_anim_label = AnimationLabel(self.widget)
        self.test_anim_label.setGeometry(QtCore.QRect(660, 490, 91, 51))
        font = QtGui.QFont()
        font.setFamily("Exo 2")
        font.setPointSize(20)
        self.test_anim_label.setFont(font)
        self.test_anim_label.setStyleSheet("color:white")
        self.test_anim_label.setObjectName("test_anim_label")
        self.test_icon = QtWidgets.QLabel(self.widget)
        self.test_icon.setGeometry(QtCore.QRect(580, 490, 51, 51))
        self.test_icon.setStyleSheet("color:white")
        self.test_icon.setText("")
        self.test_icon.setPixmap(QtGui.QPixmap("flag-test.svg"))
